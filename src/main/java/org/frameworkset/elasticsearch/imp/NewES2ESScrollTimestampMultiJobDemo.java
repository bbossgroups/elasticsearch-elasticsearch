...
public class NewES2ESScrollTimestampMultiJobDemo {
	public static void main(String[] args){
		NewES2ESScrollTimestampMultiJobDemo esDemo = new NewES2ESScrollTimestampMultiJobDemo();

		esDemo.scheduleScrollRefactorImportData("job1");
		esDemo.scheduleScrollRefactorImportData("job2");

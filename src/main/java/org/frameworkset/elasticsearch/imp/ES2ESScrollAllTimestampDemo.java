 ...
 * @version 1.0
 */
public class ES2ESScrollAllTimestampDemo {
	public static void main(String[] args){
		ES2ESScrollAllTimestampDemo esDemo = new ES2ESScrollAllTimestampDemo();
...
//				.addParam("var3","v3");
		...
		elasticsearchOutputConfig.setIndex("es2esdemo"); //设置要目标elasticsearch索引名称
 ...
 */
		elasticsearchOutputConfig.setEsIdField("meta:_id");
